    ...
    private void initRecyclerView() {
        ...
        mRv.setAdapter(new RecyclerView.Adapter() {
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
                ...
                Log.d(TAG, "onBindViewHolder: getImage_url succeed:"+url);
            }
        ...
        getMultipartFromUri("cover_image", mSelectedImage),getMultipartFromUri("video", mSelectedVideo)).
                enqueue(new Callback<PostVideoResponse>() {
                    ...
                    public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                        Toast.makeText(Solution2C2Activity.this, "postVideo SUCCESS",Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<PostVideoResponse> call, Throwable t) {
                        ...
                        Toast.makeText(Solution2C2Activity.this, "postVideo FAILED",Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        retrofit.create(IMiniDouyinService.class).getFeedResponse().
                enqueue(new Callback<FeedResponse>() {
                    ...
                    public void onResponse(Call<FeedResponse> call, Response<FeedResponse> response) {
                        ...
                        resetRefreshBtn();
                        Toast.makeText(Solution2C2Activity.this, "fetchFeed Succed",Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(Call<FeedResponse> call, Throwable t) {
                        Toast.makeText(Solution2C2Activity.this, "fetchFeed FAILED",Toast.LENGTH_SHORT).show();
                        resetRefreshBtn();
                    }
                });
